...
/* Aşağıda verilen elemanları bir dizi içerisinde saklayınız.
     ...
     studentA : sinan özçelik 2010
     StudentB : test sample  1999
     studentC : user sample 1998   

*/

var studentA = ["sinan", "özçelik", 2010];
var studentB = ["test", "sample", 1999];
var studentC = ["user", "sample", 1998];
