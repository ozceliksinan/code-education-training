package androidjava.sinanozcelik.jsonhomeworkapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    // AndroidManifest.xml dosyamıza android:usesCleartextTraffic="true" kodunu ekledik.
    // İnternetten veya herhangi bir yerden veri çekerken, çekilen verinin düzgün işlenebilmesi için bu kodun eklenmesi gereklidir.

    //Uygulama internete bağlanıp veri çekileceği için androidde bu işlemler için özel bir kütüphane vardır.
    //Bu kütüphanenin projemize dahil edilmesi gereklidir. Volley kütüphanesini ekleyelim.
    //İlgili kütüphaneyi build.gradle(Modules) altına ekleyelim. Bu komut eklenmelidir -> implementation 'com.android.volley:volley:1.1.1'
